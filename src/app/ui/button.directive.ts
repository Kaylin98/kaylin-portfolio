...
/**
 * Usage: works on <button> or <a> (incl. its
 * "asChild" pattern, since this is just an attribute here instead of a component).
 *
 *   <button appButton variant="outline" size="lg">Click me</button>
 *   <a appButton variant="ghost" size="sm" href="https://github.com">GitHub</a>
 */
@Directive({
  selector: '[appButton]',
  standalone: true,
